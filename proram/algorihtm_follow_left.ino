...
void loop() {
  ...
  while(r < 0.6){
    ...
    if(distance_left < 40 && distance_front > 20){            // note : change this value "40" and "20" depents on your robot dimension
      isPD();
    }else if(distance_left < 40 && distance_front <= 20){     // note : change this value "40" and "20" depents on your robot dimension
      turnRight(85);
    }else if(distance_left >= 40 && distance_front > 20){     // note : change this value "40" and "20" depents on your robot dimension
      isPD();
    }else if(distance_left >= 40 && distance_front <= 20){    // note : change this value "40" and "20" depents on your robot dimension
