...
const int speed_point = 65;     // note : change this value depent on your robot PWM
int speed_left;
int speed_right;

const double set_point = 17;    // note : change this value depent on yours
...
void loop() {
  ...
  readSensor();
  // While_the_robots_not_on_the_finish_color, so_the_robot_will_go_on
  while(r < 0.6){
    readSensor();
    ...
    if(distance_right < 40 && distance_front > 20){            // note : change this value "40" and "20" depents on your robot dimension
      isPD();
    }else if(distance_right < 40 && distance_front <= 20){     // note : change this value "40" and "20" depents on your robot dimension
      turnLeft(85);
    }else if(distance_right >= 40 && distance_front > 20){     // note : change this value "40" and "20" depents on your robot dimension
      isPD();
    }else if(distance_right >= 40 && distance_front <= 20){    // note : change this value "40" and "20" depents on your robot dimension
